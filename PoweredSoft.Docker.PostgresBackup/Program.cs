...
using PoweredSoft.Docker.PostgresBackup.Backup;
using PoweredSoft.Docker.PostgresBackup.Notifications;
using PoweredSoft.Docker.PostgresBackup.Notifications.Slack;
using PoweredSoft.Docker.PostgresBackup.Notifications.Teams;
using PoweredSoft.Docker.PostgresBackup.Retention;
using PoweredSoft.Docker.PostgresBackup.Storage.Azure;
using PoweredSoft.Docker.PostgresBackup.Storage.Physical;
using PoweredSoft.Docker.PostgresBackup.Storage.S3;
...
namespace PoweredSoft.Docker.PostgresBackup
{
    ...
    public class Program
    {
        ...
        private static void AddConfigurationServices(IServiceCollection services)
        {
            ...
            services.AddSingleton<PostresConfiguration>(ctx =>
            {
                var t = new PostresConfiguration();
                configuration.Bind("Postgres", t);
                return t;
            });
